...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
var config, en_messages, iced, initView, keys, pages, updatePricing, util, __iced_k, __iced_k_noop,
  __slice = [].slice;
...
updatePricing = function() {
  var pricing, ___iced_passed_deferral, __iced_deferrals, __iced_k;
  ...
  (function(_this) {
    return (function(__iced_k) {
      __iced_deferrals = new iced.Deferrals(__iced_k, {
        ...
        filename: "/Users/nubela/Workspace/picturebook-chrome-extension/src/html/pricing.coffee"
      });
      util.fetchLatestPricing(__iced_deferrals.defer({
        assign_fn: (function() {
          return function() {
    ...
    return function() {
      return $("#pricing-span").text("$" + pricing);
    };
  })(this));
};
...
initView = function() {
  $("#upgrade-btn").on("click", function() {
    var laddaBtn, paypalUrl, pricingObj, saasyUrl, ___iced_passed_deferral, __iced_deferrals, __iced_k;
    __iced_k = __iced_k_noop;
    ___iced_passed_deferral = iced.findDeferral(arguments);
    laddaBtn = Ladda.create(document.querySelector('#upgrade-ladda-btn'));
    laddaBtn.start();
    (function(_this) {
      return (function(__iced_k) {
        __iced_deferrals = new iced.Deferrals(__iced_k, {
        ...
        util.getQuotationAndUrls(__iced_deferrals.defer({
          assign_fn: (function() {
            return function() {
              pricingObj = arguments[0];
              paypalUrl = arguments[1];
              return saasyUrl = arguments[2];
            };
          })(),
          lineno: 18
        }));
      ...
      return function() {
        if (null === pricingObj || null === paypalUrl || null === saasyUrl) {
          laddaBtn.stop();
          util.setLocalData(keys.SERVICE_TOKEN, null);
          util.redirect(pages.SIGN_IN);
        }
        (function(__iced_k) {
          __iced_deferrals = new iced.Deferrals(__iced_k, {
            parent: ___iced_passed_deferral,
          ...
          util.setLocalData(keys.CACHED_PAYPAL_PAYMENT_URL, paypalUrl, __iced_deferrals.defer({
            lineno: 24
          }));
          __iced_deferrals._fulfill();
        })(function() {
          (function(__iced_k) {
            ...
            util.setLocalData(keys.CACHED_SAASY_PAYMENT_URL, saasyUrl, __iced_deferrals.defer({
              lineno: 25
            }));
            __iced_deferrals._fulfill();
          })(function() {
            (function(__iced_k) {
              ...
              util.setLocalData(keys.CACHED_PRICING, pricingObj, __iced_deferrals.defer({
                lineno: 26
              }));
              __iced_deferrals._fulfill();
            })(function() {
              return util.redirect(pages.QUOTATION);
            });
          });
        });
      };
...
}).call(this,require("pBGvAp"),typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {},require("buffer").Buffer,arguments[3],arguments[4],arguments[5],arguments[6],"/fake_80284f3a.js","/")
